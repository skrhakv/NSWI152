...
namespace ServiceBus
{
    class Program
    {
        static string connectionString = "Endpoint=sb://myservbustest.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=CndLQsk4LDEyXcCmS8mtmkS62vkD5SvRafXwByY9GMI=";
